			...
			var datatable=$('#kt_datatable').KTDatatable({
				...
				data: {
					...
					source: {
						read: {
							url:API_URL,
							params:{action:'studentslist',user_status:user_status,campus_id:campus_id},
						},
					...
					},
					{
						...
						template: function(data){
						 ...
						 return '\
	                        ...
	                        '+btn+'\
	                        <a href="javascript:void(0);" class="label label-primary label-inline font-weight-bolder mr-2" onclick="Students.resetPassword('+data.id+',\''+ data.first_name +'\');">Reset</a>\
	                       ';
						}
					}
				]
